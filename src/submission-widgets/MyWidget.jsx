    ...
    <div className="relative">
      ...
      <div className={`transform transition-transform duration-300 ease-in-out ${isMenuOpen ? 'translate-x-64' : 'translate-x-0'} z-10`}>
        <div
          ...
          onDrop={handleDrop}
          className={`glass p-4 md:p-6 mx-auto relative transition-all duration-500 ease-in-out flex flex-col justify-start items-center ${getSizeClasses()} min-h-[280px] overflow-hidden ${backgroundImage ? 'has-background' : ''}`}
          style={{
